...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{ggplot}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{aes}}.
#' @inherit ggplot2::aes
#' @export
ggaes <- function(x, y, ...) {ggplot2::aes(x, y, ...)}

#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{geom_point}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{element_line}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggtext]{element_markdown}}
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{element_blank}}.
#' @inherit ggplot2::element_blank
#' @export
ggenull <- function() {ggplot2::element_blank()}

#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{element_rect}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{element_text}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{expansion}}.
#' @inherit ggplot2::expansion
#' @export
ggexp <- function(mult = 0, add = 0) {ggplot2::expansion(mult = mult, add = add)}

#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{facet_grid}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{geom_hline}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{geom_label}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{labs}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{geom_line}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{ggsave}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{scale_x_continuous}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{scale_y_continuous}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{theme}}.
#' @export
ggthm <- function(...) {ggplot2::theme(...)}

#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{theme_minimal}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{geom_text}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{unit}}.
#' @inherit ggplot2::unit
#' @export
ggunit <- function(x, units, data = NULL) {ggplot2::unit(x, units, data = data)}

#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{vars}}.
#' @inherit ggplot2::vars
#' @export
ggvars <- function(...) {ggplot2::vars(...)}

#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{geom_vline}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{facet_wrap}}.
...
#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{xlab}}.
#' @inherit ggplot2::xlab
#' @export
ggxlab <- function(label) {ggplot2::xlab(label)}

#' @describeIn wrap_gg Thin wrap of \code{\link[ggplot2]{ylab}}.
