#' @name cmp_xmd_mvc
#' @family props
#' @title complete + xmd + atomic mvect
#' @description See \code{\link{xmd}}, and \code{\link{is_cmp_mvect}}.
#' @param x An object
#' @return \code{TRUE} or \code{FALSE}.
#' @export
cmp_xmd_mvc_vals <- function() {
  x <- paste0("cmp_", c("atm", xmd_vals()), "_mvc")
  names(x) <- rep.int("cmp_xmd_mvc", length(x))
  x
}
