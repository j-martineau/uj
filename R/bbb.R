...
#' bbb(NA)
#' @export
bbb_help <- function() {utils::help("bbb_help", package = "uj")}

#' @describeIn bbb_help Lists all basic properties of `x`. Returns a sorted, lowercase, character vector.
#' @export
bbb <- function(x) {
  y <- NULL
...
#' @describeIn bbb_help Lists all basic-property-checking functions. Returns a sorted, uppercase, character vector.
#' @export
bbb_funs <- function() {base::c("ATM", "DEF", "FUN", "NIL", "NLL", "POP", "RCR")}

#' @describeIn bbb_help Lista all basic properties. Returns a sorted, lowercase, character vector.
#' @export
bbb_props <- function() {base::c("atm", "def", "fin", "nil", "nll", "pop", "rcr")}

#' @describeIn bbb_help Checks whether `spec` is a basic property spec. Returns a logical scalar. See \code{\link{ppp}} for a definition of a property spec.
#' @export
...
#' @describeIn bbb_help Checks `x` against the basic property spec `spec` subject to any count or value restrictions in `...`. Returns a logical scalar. See \code{\link{ppp}} for a definition of a property spec.
#' @export
BBB <- function(x, spec, ...) {
...
#' @describeIn bbb_help Checks `x` atomic-ness subject to any count or value restrictions in `...`. Returns a logical scalar.
#' @export
ATM <- function(x, ...) {uj::BBB(x, 'atm', ...)}

#' @describeIn bbb_help Checks `x` for defined-ness subject to any count or value restrictions in `...`. Returns a logical scalar.
#' @export
DEF <- function(x, ...) {uj::BBB(x, 'def', ...)}

#' @describeIn bbb_help Checks `x` for function-ness subject to any count or value restrictions in `...`. Returns a logical scalar.
#' @export
FUN <- function(x, ...) {uj::BBB(x, 'fun', ...)}

#' @describeIn bbb_help Checks `x` ni-lness subject to any count or value restrictions in `...`. Returns a logical scalar.
#' @export
NIL <- function(x) {uj::BBB(x, 'nil')}

#' @describeIn bbb_help Checks `x` for null-ness subject to any count or value restrictions in `...`. Returns a logical scalar.
#' @export
NLL <- function(x) {uj::BBB(x, 'nll')}

#' @describeIn bbb_help Checks `x` for populated-ness subject to any count or value restrictions in `...`. Returns a logical scalar.
#' @export
POP <- function(x, ...) {uj::BBB(x, 'pop', ...)}

#' @describeIn bbb_help Checks `x` for recursive-ness subject to any count or value restrictions in `...`. Returns a logical scalar.
#' @export
