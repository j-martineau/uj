...
#' @param n A \link[ppp:cmp_psw_scl]{complete positive whole-number scalar} indicating the length of set of unique values.
#' @return A \link[ppp:cmp_psw_vls]{complete positive whole-number vlist}.
#' @examples
#' sets(1)
#' sets(2)
#' sets(3)
