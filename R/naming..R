...
#'      `rcnamed`   \tab Evaluates whether both rows and columns are named.
#'   \cr            \tab   
#'   \cr `enamed`   \tab Evaluates whether elements of `x` named.
#'   \cr            \tab   
#'   \cr `rnamed`   \tab Evaluates whether rows of `x` are named
#'   \cr            \tab   
#'   \cr `cnamed`   \tab Evaluates whether columns of `x` are named.
#'   \cr            \tab   
#'   \cr `dnamed`   \tab Evaluates whether `...` arguments are named
#'   \cr            \tab   
...
#' }\cr\tabular{rl}{
#'       `namerc`   \tab Names rows and columns of `x`.
#'   \cr            \tab   
#'   \cr  `namer`   \tab Names rows of `x`.
#'   \cr            \tab   
#'   \cr  `namec`   \tab Names columns of `x`.
#'   \cr            \tab   
#'   \cr  `namev`   \tab names elements of a vector or \link[=ivls]{vlist}.
#'   \cr            \tab   
...
#'   \cr            \tab   
#'   \cr    `rcn`   \tab get row vs. column vs. both row and column names, respectively.
#'   \cr            \tab   
#'   \cr     `en`   \tab gets element names.
#'   \cr            \tab   
#'   \cr     `rn`   \tab get row vs. column vs. both row and column names, respectively.
#'   \cr            \tab   
#'   \cr     `cn`   \tab get row vs. column vs. both row and column names, respectively.
#' }
...
#'   \cr            \tab   
#'   \cr    `rcn`   \tab A list of `2` character vectors.
