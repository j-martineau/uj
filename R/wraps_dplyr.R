...
#' @describeIn wraps_dplyr Thin wrap aggregation with
#'   \code{\link[dplyr]{summarize}}.
#' @inherit dplyr::summarize
#' @export
dpagg <- function(.data, ..., .groups = NULL) {dplyr::summarize(.data, ..., .groups = .groups)}

#' @describeIn wraps_dplyr Thin wrap of \code{\link[dplyr]{n}}.
#' @inherit dplyr::n
#' @export
dpn <- function() {dplyr::n()}

#' @describeIn wraps_dplyr Thin wrap of \code{\link[dplyr]{all_of}}.
#' @inherit dplyr::all_of
#' @export
dpall <- function(x) {dplyr::all_of(x)}

#' @describeIn wraps_dplyr Limited functionality wrap of
...
#' @describeIn wraps_dplyr Thin wrap of \code{\link[dplyr]{left_join}}.
...
#' @describeIn wraps_dplyr Thin wrap of \code{\link[dplyr]{rename}}.
#' @inherit dplyr::rename
#' @export
dplab <- function(.data, ...) {dplyr::rename(.data, ...)}

#' @describeIn wraps_dplyr Thin wrap of \code{\link[dplyr]{mutate}}.
