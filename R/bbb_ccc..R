...
#'     `bbb_ccc_props`   \tab Gets a character vector of all possible \link[=bbb]{base} + \link[=ccc]{extended class} properties.
#'   \cr                 \tab  
#'   \cr     `bbb_ccc`   \tab Evaluates whether `x` matches arguments `bbb`\eqn{^1} and `ccc`\eqn{^2} (subject to any restrictions in `...`).
#'   \cr                 \tab  
...
#' }
#' \eqn{^{3.}} `xxx` and `yyy` represent a base property and an extended class property, respectively.
#' @examples
#' bbb_ccc_props()
