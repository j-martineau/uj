#' @name cmp_xmd_atb
#' @family props
#' @title complete + xmd + atomic tibble
#' @description See \code{\link{xmd}}, and \code{\link{is_cmp_tibble}}.
#' @param x An object
#' @return \code{TRUE} or \code{FALSE}.
#' @export
cmp_xmd_atb_vals <- function() {
  x <- paste0("cmp_", c("atm", xmd_vals()), "_atb")
  names(x) <- rep.int("cmp_xmd_atb", length(x))
  x
}
