...
#' @describeIn delim Delimit within vectors in \code{...} using \code{w.}, then
#'   delimit across using \code{a.}, resulting in a character-scalar string
...
#' @describeIn delim Delimit across vectors in \code{...} using (back)-quotes.
#' @export
daQ <- function(...) {da(a. = '`', ...)}

#' @describeIn delim Delimit across vectors in \code{...} using simple commas.
#' @export
daS <- function(...) {da(a. = ',', ...)}
...
#' @describeIn delim Delimit within vectors in \code{...} using (back)-quotes.
#' @export
dwQ <- function(...) {dw(w. = '`', ...)}

#' @describeIn delim Delimit within vectors in \code{...} using simple commas.
#' @export
dwS <- function(...) {dw(w. = ',', ...)}
