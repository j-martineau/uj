...
delim_uj <- function() {help("delim_uj", package = "uj")}

#' @describeIn delim_uj Delimit across vectors in \code{...} using \code{a.}
...
#' @describeIn delim_uj Delimit within vectors in \code{...} using \code{w.},
...
#' @describeIn delim_uj Delimit across vectors in \code{...} using blanks.
#' @export
da0 <- function(...) {da(a. = '', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using spaces.
#' @export
da1 <- function(...) {da(a. = ' ', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using broken-pipes.
#' @export
daB <- function(...) {da(a. = '¦', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using colons.
#' @export
daC <- function(...) {da(a. = ':', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using dots/periods.
#' @export
daD <- function(...) {da(a. = '.', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using grammatical
#'   commas.
#' @export
daG <- function(...) {da(a. = ', ', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using pipes.
#' @export
daP <- function(...) {da(a. = '|', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using
#'   (back)-quotes.
#' @export
daQ <- function(...) {da(a. = '`', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using simple
#'   commas.
#' @export
daS <- function(...) {da(a. = ',', ...)}

#' @describeIn delim_uj Delimit across vectors in \code{...} using tildes.
#' @export
daT <- function(...) {da(a. = '~', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using blanks.
#' @export
dw0 <- function(...) {dw(w. = '', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using spaces.
#' @export
dw1 <- function(...) {dw(w. = ' ', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using broken-pipes.
#' @export
dwB <- function(...) {dw(w. = '¦', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using colons.
#' @export
dwC <- function(...) {dw(w. = ':', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using dots/periods.
#' @export
dwD <- function(...) {dw(w. = '.', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using grammatical
#'   commas.
#' @export
dwG <- function(...) {dw(w. = ', ', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using pipes.
#' @export
dwP <- function(...) {dw(w. = '|', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using
#'   (back)-quotes.
#' @export
dwQ <- function(...) {dw(w. = '`', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using simple
#'   commas.
#' @export
dwS <- function(...) {dw(w. = ',', ...)}

#' @describeIn delim_uj Delimit within vectors in \code{...} using tildes.
#' @export
dwT <- function(...) {dw(w. = '~', ...)}

#' @describeIn delim_uj Delimit \emph{across} then \emph{within} vectors in
...
#' @describeIn delim_uj Delimit \emph{within} then \emph{across} vectors in
#'   \code{...} using \emph{blanks}.
#' @export
