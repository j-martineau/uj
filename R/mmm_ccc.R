...
#' @export
mmm_ccc_uj <- function() {help("mmm_ccc_uj", package = "uj")}

#' @describeIn mmm_ccc_uj Get a character vector of all possible extended mode +
...
#' @describeIn mmm_ccc_uj Is \code{x} a onechar array? (\code{\link{ich1}},
#'   \code{\link{iarr}})
#' @export
ch1_arr <- function(x) {atm_arr(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a onechar generic? (\code{\link{ich1}},
#'   \code{\link{iagn}})
#' @export
ch1_gen <- function(x) {atm_gen(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a onechar tabular? (\code{\link{ich1}},
#'   \code{\link{iatb}})
#' @export
ch1_tab <- function(x) {atm_tab(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a onechar vlist? (\code{\link{ich1}},
#'   \code{\link{iavl}})
#' @export
ch1_vls <- function(x) {atm_vls(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a onechar vtype? (\code{\link{ich1}},
#'   \code{\link{iavt}})
#' @export
ch1_vtp <- function(x) {atm_vtp(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a onechar matrix? (\code{\link{ich1}},
#'   \code{\link{imat}})
#' @export
ch1_mat <- function(x) {atm_mat(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a onechar multivec? (\code{\link{ich1}},
#'   \code{\link{imvc}})
#' @export
ch1_mvc <- function(x) {atm_mvc(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a onechar scalar? (\code{\link{ich1}},
#'   \code{\link{iscl}})
#' @export
ch1_scl <- function(x) {atm_scl(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a onechar vector? (\code{\link{ich1}},
#'   \code{\link{ivec}})
#' @export
ch1_vec <- function(x) {atm_vec(x, 'ch1')}

#' @describeIn mmm_ccc_uj Is \code{x} a character array? (\code{\link{ichr}},
#'   \code{\link{iarr}})
#' @export
chr_arr <- function(x) {atm_arr(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a character generic? (\code{\link{ichr}},
#'   \code{\link{iagn}})
#' @export
chr_gen <- function(x) {atm_gen(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a character tabular? (\code{\link{ichr}},
#'   \code{\link{iatb}})
#' @export
chr_tab <- function(x) {atm_tab(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a character vlist? (\code{\link{ichr}},
#'   \code{\link{iavl}})
#' @export
chr_vls <- function(x) {atm_vls(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a character vtype? (\code{\link{ichr}},
#'   \code{\link{iavt}})
#' @export
chr_vtp <- function(x) {atm_vtp(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a character matrix? (\code{\link{ichr}},
#'   \code{\link{imat}})
#' @export
chr_mat <- function(x) {atm_mat(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a character multivec? (\code{\link{ichr}},
#'   \code{\link{imvc}})
#' @export
chr_mvc <- function(x) {atm_mvc(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a character scalar? (\code{\link{ichr}},
#'   \code{\link{iscl}})
#' @export
chr_scl <- function(x) {atm_scl(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a character vector? (\code{\link{ichr}},
#'   \code{\link{ivec}})
#' @export
chr_vec <- function(x) {atm_vec(x, 'chr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color array? (\code{\link{iclr}},
#'   \code{\link{iarr}})
#' @export
clr_arr <- function(x) {atm_arr(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color generic? (\code{\link{iclr}},
#'   \code{\link{igen}})
#' @export
clr_gen <- function(x) {atm_gen(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color tabular? (\code{\link{iclr}},
#'   \code{\link{iatb}})
#' @export
clr_tab <- function(x) {atm_tab(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color vlist? (\code{\link{iclr}},
#'   \code{\link{iavl}})
#' @export
clr_vls <- function(x) {atm_vls(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color vtype? (\code{\link{iclr}},
#'   \code{\link{iavt}})
#' @export
clr_vtp <- function(x) {atm_vtp(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color matrix? (\code{\link{iclr}},
#'   \code{\link{imat}})
#' @export
clr_mat <- function(x) {atm_mat(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color multivec? (\code{\link{iclr}},
#'   \code{\link{imvc}})
#' @export
clr_mvc <- function(x) {atm_mvc(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color scalar? (\code{\link{iclr}},
#'   \code{\link{iscl}})
#' @export
clr_scl <- function(x) {atm_scl(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} a color vector? (\code{\link{iclr}},
#'   \code{\link{ivec}})
#' @export
clr_vec <- function(x) {atm_vec(x, 'clr')}

#' @describeIn mmm_ccc_uj Is \code{x} an even-valued whole-number array?
#'   (\code{\link{ievn}}, \code{\link{iarr}})
#' @export
evn_arr <- function(x) {atm_arr(x, 'evn')}

#' @describeIn mmm_ccc_uj Is \code{x} an even-valued whole-number generic?
#'   (\code{\link{ievn}}, \code{\link{iagn}})
#' @export
evn_gen <- function(x) {atm_gen(x, 'evn')}

#' @describeIn mmm_ccc_uj Is \code{x} an even-valued whole-number tabular?
#'   (\code{\link{ievn}}, \code{\link{iatb}})
#' @export
evn_tab <- function(x) {atm_tab(x, 'evn')}

#' @describeIn mmm_ccc_uj Is \code{x} an even-valued whole-number vlist?
#'   (\code{\link{ievn}}, \code{\link{iavl}})
#' @export
evn_vls <- function(x) {atm_vls(x, 'evn')}

#' @describeIn mmm_ccc_uj Is \code{x} an even-valued
#'   whole-number vtype?
...
#' @describeIn mmm_ccc_uj Is \code{x} an even-valued whole-number scalar?
#'   (\code{\link{ievn}}, \code{\link{iscl}})
#' @export
evn_scl <- function(x) {atm_scl(x, 'evn')}

#' @describeIn mmm_ccc_uj Is \code{x} an even-valued whole-number vector?
#'   (\code{\link{ievn}}, \code{\link{ivec}})
#' @export
evn_vec <- function(x) {atm_vec(x, 'evn')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor array? (\code{\link{ifac}},
#'   \code{\link{iarr}})
#' @export
fac_arr <- function(x) {atm_arr(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor generic? (\code{\link{ifac}},
#'   \code{\link{iagn}})
#' @export
fac_gen <- function(x) {atm_gen(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor tabular? (\code{\link{ifac}},
#'   \code{\link{iatb}})
#' @export
fac_tab <- function(x) {atm_tab(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor vlist? (\code{\link{ifac}},
#'   \code{\link{iavl}})
#' @export
fac_vls <- function(x) {atm_vls(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor vtype? (\code{\link{ifac}},
#'   \code{\link{iavt}})
#' @export
fac_vtp <- function(x) {atm_vtp(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor matrix? (\code{\link{ifac}},
#'   \code{\link{imat}})
#' @export
fac_mat <- function(x) {atm_mat(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor multivec? (\code{\link{ifac}},
#'   \code{\link{imvc}})
#' @export
fac_mvc <- function(x) {atm_mvc(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor scalar? (\code{\link{ifac}},
#'   \code{\link{iscl}})
#' @export
fac_scl <- function(x) {atm_scl(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a factor vector? (\code{\link{ifac}},
#'   \code{\link{ivec}})
#' @export
fac_vec <- function(x) {atm_vec(x, 'fac')}

#' @describeIn mmm_ccc_uj Is \code{x} a fractional-valued numeric array?
#'   (\code{\link{ifrc}}, \code{\link{iarr}})
#' @export
frc_arr <- function(x) {atm_arr(x, 'frc')}

#' @describeIn mmm_ccc_uj Is \code{x} a fractional-valued numeric generic?
#'   (\code{\link{ifrc}}, \code{\link{iagn}})
#' @export
frc_gen <- function(x) {atm_gen(x, 'frc')}

#' @describeIn mmm_ccc_uj Is \code{x} a fractional-valued numeric tabular?
#'   (\code{\link{ifrc}}, \code{\link{iatb}})
#' @export
frc_tab <- function(x) {atm_tab(x, 'frc')}

#' @describeIn mmm_ccc_uj Is \code{x} a fractional-valued numeric vlist?
#'   (\code{\link{ifrc}}, \code{\link{iavl}})
#' @export
frc_vls <- function(x) {atm_vls(x, 'frc')}

#' @describeIn mmm_ccc_uj Is \code{x} a fractional-valued numeric vtype?
#'   (\code{\link{ifrc}}, \code{\link{iavt}})
#' @export
frc_vtp <- function(x) {atm_vtp(x, 'frc')}

#' @describeIn mmm_ccc_uj Is \code{x} a fractional-valued
#'   numeric matrix?
...
#' @describeIn mmm_ccc_uj Is \code{x} an indexer
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} an indexer
#'   tabular?
#'   (\code{\link{iind}}, \code{\link{iatb}})
#' @export
ind_tab <- function(x) {atm_tab(x, 'ind')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a logical
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a logical
#'   tabular?
#'   (\code{\link{ilgl}}, \code{\link{iatb}})
#' @export
lgl_tab <- function(x) {atm_tab(x, 'lgl')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a negative-valued
#'   numeric array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a negative-valued
#'   numeric tabular?
#'   (\code{\link{ineg}}, \code{\link{iatb}})
#' @export
neg_tab <- function(x) {atm_tab(x, 'neg')}
...
#'   (\code{\link{ingw}}, \code{\link{iatb}})
#' @export
ngw_tab <- function(x) {atm_tab(x, 'ngw')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a non-negative-valued
#'   numeric array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a non-negative-valued
#'   numeric tabular?
#'   (\code{\link{inng}}, \code{\link{iatb}})
#' @export
nng_tab <- function(x) {atm_tab(x, 'nng')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a non-negative-valued
#'   whole-number tabular?
#'   (\code{\link{innw}}, \code{\link{iatb}})
#' @export
nnw_tab <- function(x) {atm_tab(x, 'nnw')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a non-positive-valued
#'   numeric array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a non-positive-valued
#'   numeric tabular?
#'   (\code{\link{inps}}, \code{\link{iatb}})
#' @export
nps_tab <- function(x) {atm_tab(x, 'nps')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a non-positive-valued
#'   whole-number tabular?
#'   (\code{\link{inpw}}, \code{\link{iatb}})
#' @export
npw_tab <- function(x) {atm_tab(x, 'npw')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a non-sortable
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a non-sortable
#'   tabular?
#'   (\code{\link{inst}}, \code{\link{iatb}})
#' @export
nst_tab <- function(x) {atm_tab(x, 'nst')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a numeric
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a numeric
#'   tabular?
#'   (\code{\link{inum}}, \code{\link{iatb}})
#' @export
num_tab <- function(x) {atm_tab(x, 'num')}
...
#' @describeIn mmm_ccc_uj Is \code{x} an odd-valued
#'   whole-number array?
...
#' @describeIn mmm_ccc_uj Is \code{x} an odd-valued
#'   whole-number tabular?
#'   (\code{\link{iodd}}, \code{\link{iatb}})
#' @export
odd_tab <- function(x) {atm_tab(x, 'odd')}
...
#' @describeIn mmm_ccc_uj Is \code{x} an ordered-factor
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} an ordered-factor
#'   tabular?
#'   (\code{\link{iord}}, \code{\link{iatb}})
#' @export
ord_tab <- function(x) {atm_tab(x, 'ord')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a percent-valued
#'   (0-100) numeric array?
...
#'   (\code{\link{ipct}}, \code{\link{iatb}})
#' @export
pct_tab <- function(x) {atm_tab(x, 'pct')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a positive-valued
#'   numeric array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a positive-valued
#'   numeric tabular?
#'   (\code{\link{ipos}}, \code{\link{iatb}})
#' @export
pos_tab <- function(x) {atm_tab(x, 'pos')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a proportion-valued
#'   (0-1) numeric array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a proportion-valued
#'   (0-1) numeric tabular?
#'   (\code{\link{ippn}}, \code{\link{iatb}})
#' @export
ppn_tab <- function(x) {atm_tab(x, 'ppn')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a positive-valued
#'   whole-number tabular?
#'   (\code{\link{ipsw}}, \code{\link{iatb}})
#' @export
psw_tab <- function(x) {atm_tab(x, 'psw')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a sortable
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a sortable
#'   tabular?
#'   (\code{\link{isrt}}, \code{\link{iatb}})
#' @export
srt_tab <- function(x) {atm_tab(x, 'srt')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a string
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a string
#'   tabular?
#'   (\code{\link{istr}}, \code{\link{iatb}})
#' @export
str_tab <- function(x) {atm_tab(x, 'str')}
...
#' @describeIn mmm_ccc_uj Is \code{x} an unordered-factor
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} an unordered-factor
#'   tabular?
#'   (\code{\link{iuno}}, \code{\link{iatb}})
#' @export
uno_tab <- function(x) {atm_tab(x, 'uno')}
...
#' @describeIn mmm_ccc_uj Is \code{x} a whole-number
#'   array?
...
#' @describeIn mmm_ccc_uj Is \code{x} a whole-number
#'   tabular?
#'   (\code{\link{iwhl}}, \code{\link{iatb}})
#' @export
whl_tab <- function(x) {atm_tab(x, 'whl')}
