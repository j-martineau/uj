...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{ggplot}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{aes}}.
#' @inherit ggplot2::aes
#' @export
ggaes <- function(x, y, ...) {ggplot2::aes(x, y, ...)}

#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{geom_point}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{element_line}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggtext]{element_markdown}}
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{element_blank}}.
#' @inherit ggplot2::element_blank
#' @export
ggenull <- function() {ggplot2::element_blank()}

#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{element_rect}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{element_text}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{expansion}}.
#' @inherit ggplot2::expansion
#' @export
ggexp <- function(mult = 0, add = 0) {ggplot2::expansion(mult = mult, add = add)}

#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{facet_grid}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{geom_hline}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{geom_label}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{labs}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{geom_line}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{ggsave}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{scale_x_continuous}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{scale_y_continuous}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{theme}}.
#' @export
ggthm <- function(...) {ggplot2::theme(...)}

#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{theme_minimal}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{geom_text}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{unit}}.
#' @inherit ggplot2::unit
#' @export
ggunit <- function(x, units, data = NULL) {ggplot2::unit(x, units, data = data)}

#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{vars}}.
#' @inherit ggplot2::vars
#' @export
ggvars <- function(...) {ggplot2::vars(...)}

#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{geom_vline}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{facet_wrap}}.
...
#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{xlab}}.
#' @inherit ggplot2::xlab
#' @export
ggxlab <- function(label) {ggplot2::xlab(label)}

#' @describeIn wraps_gg Thin wrap of \code{\link[ggplot2]{ylab}}.
