...
#' \itemize{
#'   \item **`TEST(x, ...)`**: an extended analog of `isTRUE(x)`.
...
#' }
#' This next set of functions evaluate an arbitrary number of `...` arguments expected to be logical scalars:\itemize{
...
#' \itemize{
#'   \item **`w(.)`**: numerically indexes `TRUE` values in each sweep (a sweeping version of `base::which`).
