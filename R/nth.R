...
#' n_th_rev(letters, )
#' @export
n_th_uj <- function() {help("n_th_uj", package = "uj")}

#' @describeIn n_th_uj Get the \code{n}-th element(s) of a vector (from the
#'   front).
#' @export
n_th <- function(x, n) {x[n]}

#' @describeIn n_th_uj Get the first \code{n} elements of a vector.
#' @export
...
#' @describeIn n_th_uj Get the last \code{n} elements of a vector.
#' @export
last_n <- function(x, n) {n <- 1:n; x[1 + length(x) - n]}

#' @describeIn n_th_uj Get the \code{n}-th from last element(s).
#' @export
