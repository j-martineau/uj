...
#' **`xmode` functions**
#' \tabular{rl}{
#'     `is_mmm_spec`   \tab Is `spec` is an `xmode` spec?
#'   \cr `mmm_props`   \tab Gets all possible `xmode` properties.
#'   \cr      `immm`   \tab Does `x` match `xmode` spec `spec`\eqn{^1}?
#'   \cr      `ixxx`   \tab Does `x` match `xmode` property `MMM`\eqn{^1}?
...
#' @return \tabular{rl}{
#'     `is_mmm_spec`   \tab A logical
#'   \cr      `iMMM`   \tab scalar.
#'   \cr      `immm`   \tab   
#'   \cr               \tab   
#'   \cr `mmm_props`   \tab A character
#'   \cr       `mmm`   \tab vector.
#' }
#' @examples
#' mmm_props()
