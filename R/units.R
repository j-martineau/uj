...
#' @export
u2u_uj <- function() {help("u2u_uj", package = "uj")}

#' @describeIn u2u_uj Convert units specifying both original and new units.
#' @export
...
#' @describeIn u2u_uj Convert to centimeter units.
#' @export
u2cm <- function(x, old) {u2u(x, old, "cm")}

#' @describeIn u2u_uj Convert to inch units.
#' @export
u2in <- function(x, old) {u2u(x, old, "in")}

#' @describeIn u2u_uj Convert to millimeter units.
#' @export
u2mm <- function(x, old) {u2u(x, old, "mm")}

#' @describeIn u2u_uj Convert to point units.
#' @export
u2pt <- function(x, old) {u2u(x, old, "pt")}

#' @describeIn u2u_uj Convert centimeters to some other units.
#' @export
cm2u <- function(x, new) {u2u(x, "cm", new)}

#' @describeIn u2u_uj Convert inches to some other units.
#' @export
in2u <- function(x, new) {u2u(x, "in", new)}

#' @describeIn u2u_uj Convert millimeters to some other units.
#' @export
mm2u <- function(x, new) {u2u(x, "mm", new)}

#' @describeIn u2u_uj Convert points to some other units.
#' @export
pt2u <- function(x, new) {u2u(x, "pt", new)}

#' @describeIn u2u_uj Convert centimeters to inches.
#' @export
cm2in <- function(x) {u2u(x, "cm", "in")}

#' @describeIn u2u_uj Convert centimeters to millimeters.
#' @export
cm2mm <- function(x) {u2u(x, "cm", "mm")}

#' @describeIn u2u_uj Convert centimeters to points.
#' @export
cm2pt <- function(x) {u2u(x, "cm", "pt")}

#' @describeIn u2u_uj Convert inches to centimeters
#' @export
in2cm <- function(x) {u2u(x, "in", "cm")}

#' @describeIn u2u_uj Convert inches to millimeters.
#' @export
in2mm <- function(x) {u2u(x, "in", "mm")}

#' @describeIn u2u_uj Convert inches to points.
#' @export
in2pt <- function(x) {u2u(x, "in", "pt")}

#' @describeIn u2u_uj Convert millimeters to centimeters.
#' @export
mm2cm <- function(x) {u2u(x, "mm", "cm")}

#' @describeIn u2u_uj Convert millimeters to inches.
#' @export
mm2in <- function(x) {u2u(x, "mm", "in")}

#' @describeIn u2u_uj Convert millimeters to points.
#' @export
mm2pt <- function(x) {u2u(x, "mm", "pt")}

#' @describeIn u2u_uj Convert points to centimeters.
#' @export
pt2cm <- function(x) {u2u(x, "pt", "cm")}

#' @describeIn u2u_uj Convert points to inches.
#' @export
pt2in <- function(x) {u2u(x, "pt", "in")}

#' @describeIn u2u_uj Convert points to millimeters.
#' @export
