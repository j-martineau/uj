#' @name xmd_agn
#' @family props
#' @title xmd + atomic generic
#' @description See \code{\link{xmd}}, and \code{\link{is_atm_generic}}.
#' @param x An object
#' @return \code{TRUE} or \code{FALSE}
#' @export
xmd_agn_vals <- function() {
  x <- paste0("", c("atm", xmd_vals()), "_agn")
  names(x) <- rep.int("xmd_agn", length(x))
  x
}
