...
#'     `uv,uav`   \tab Gets a vector of unique atomic values contained across all `...` arguments.
#'    \cr `suv`   \tab Gets a sorted vector of unique atomic values contained across all `...` arguments
#' }
