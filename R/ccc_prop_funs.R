...
#' ccc(letters)
#' @export
ccc_prop_funs <- function() {utils::help("ccc_prop_funs", package = "uj")}

#' @describeIn ccc_prop_funs Lists all extended class properties of `x`. Returns a sorted, lowercase, character vector.
#' @export
ccc <- function(x) {
  y <- NULL
...
#' @describeIn ccc_prop_funs Lists all extended class property checking functions. Returns a sorted, uppercase, character vector.
#' @export
ccc_funs <- function() {base::c("ARR", "DTF", "GEN", "MAT", "MVC", "SCL", "VEC", "VLS")}

#' @describeIn ccc_prop_funs Lists all extended class properties. Returns a sorted, lowercase, character vector.
#' @export
ccc_props <- function() {base::c("arr", "dtf", "gen", "mat", "mvc", "scl", "vec", "vls")}

#' @describeIn ccc_prop_funs Checks whether `spec` is an extended class property spec. Returns a logical scalar. See \code{\link{ppp}} for a definition of a property spec.
#' @export
...
#' @describeIn ccc_prop_funs Checks `x` against the extended class property spec `spec`. Returns a logical scalar. See \code{\link{ppp}} for a definition of a property spec.
#' @export
CCC <- function(x, spec, ...) {
...
#' @describeIn ccc_prop_funs Checks `x` for array-ness. Returns a logical scalar.
#' @export
ARR <- function(x, ...) {uj::CCC(x, 'arr', ...)}

#' @describeIn ccc_prop_funs Checks `x` for dtf-ness. Returns a logical scalar.
#' @export
DTF <- function(x, ...) {uj::CCC(x, 'dtf', ...)}

#' @describeIn ccc_prop_funs Checks `x` for generic-ness. Returns a logical scalar.
#' @export
GEN <- function(x, ...) {uj::CCC(x, 'gen', ...)}

#' @describeIn ccc_prop_funs Checks `x` for matrix-ness. Returns a logical scalar.
#' @export
MAT <- function(x, ...) {uj::CCC(x, 'mat', ...)}

#' @describeIn ccc_prop_funs Checks `x` for multivec-ness. Returns a logical scalar.
#' @export
MVC <- function(x, ...) {uj::CCC(x, 'mvc', ...)}

#' @describeIn ccc_prop_funs Checks `x` for scalar-ness. Returns a logical scalar.
#' @export
SCL <- function(x, ...) {uj::CCC(x, 'scl', ...)}

#' @describeIn ccc_prop_funs Checks `x` for vec-ness. Returns a logical scalar.
#' @export
VEC <- function(x, ...) {uj::CCC(x, 'vec', ...)}

#' @describeIn ccc_prop_funs Checks `x` for vector-list-ness. Returns a logical scalar.
#' @export
