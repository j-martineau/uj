...
#' @param d Either `NULL` or a \link[ppp:cmp_ch1_scl]{complete onechar scalar} text delimiter.
#' @param type A \link[ppp:cmp_str_scl]{complete string scalar} describing the type of file to be read.
