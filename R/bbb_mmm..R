...
#'     `bbb_mmm_props`   \tab Gets a character vector of all possible base + extended mode properties.
#'   \cr                 \tab   
#'   \cr     `bbb_mmm`   \tab Evaluates whether `x` matches the properties in arguments `bbb`\eqn{^1} and `mmm`\eqn{^2}, respectively (subject to any restrictions in `...`).
#'   \cr                 \tab   
...
#' \cr \eqn{^{2.}} An extended mode property.
#' @param x An R object
