...
#' @describeIn binfuns. Evaluates whether \code{x} and \code{y} are setequal.
...
#' @describeIn binfuns. Evaluates whether atomic scalar \code{x} is contained
...
#' @describeIn binfuns. Evaluates whether atomic object \code{x} contains
...
#' @describeIn binfuns. Evaluates whether atomic object \code{x} lacks (does
