...
#' @export
pal_colors <- function(n) {first_n(n, v(colors))}
...
#'   \code{length(v(lines))}.
#' @export
pal_lines <- function(n) {first_n(n, v(lines))}
