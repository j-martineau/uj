...
#' @export
eee_uj <- function() {help("eee_uj", package = "uj")}

#' @describeIn eee_uj Get the effective dimensionality property of \code{x.}
#' @export
eee <- function(x.) {
...
#' @describeIn eee_uj Gets the \strong{number} of effective dimensions of \code{x.}
...
#' @describeIn eee_uj Evaluate whether the effective dimensionality of \code{x.}
#'   is \code{0}.
#' @export
...
#' @describeIn eee_uj Get a character vector of all possible essential
#'   dimensionality property values.
#' @export
eee_vals <- function() {x. <- c('e0D', 'e1D', 'e2D', 'eHD', 'eUD'); names(x.) <- rep.int("eee", length(x.)); x.}

#' @describeIn eee_uj Evaluates whether any (combination) property in
