...
#'                                    \tab vector of length 1, vlist of length
#'                                         1, array of length 1, or code{1 × 1}
...
#'                                    \tab \code{\link[is_dtf]{dtf}} with
#'                                         multiple rows and multiple columns,
#'                                         matrix with multiple rows and
#'                                         multiple columns, non-empty array
#'                                         with multiple index positions in only
