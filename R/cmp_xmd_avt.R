#' @name cmp_xmd_avt
#' @family props
#' @title complete + xmd + atomic vtype
#' @description See \code{\link{xmd}}, and \code{\link{is_cmp_vtype}}.
#' @param x An object
#' @return \code{TRUE} or \code{FALSE}.
#' @export
cmp_xmd_avt_vals <- function() {
  x <- paste0("cmp_", c("atm", xmd_vals()), "_avt")
  names(x) <- rep.int("cmp_xmd_avt", length(x))
  x
}
