...
#' @description Is \code{x.} in the collective set of atomized values from
#'   \code{...}?
...
#' @describeIn is_failsafe Is \code{x.} scalar logical (\code{TRUE}, \code{FALSE}
#'   or \code{NA})?
#' @export
...
#' @describeIn is_failsafe Is \code{x.} atomic, of length 1, and not contained in
#'   any argument in \code{...}?
#' @export
notIN <- function(x., ...) {
...
#' @describeIn is_failsafe Is \code{x.} not atomic, \code{y.} not atomic, or are
#'   they not setequal?
#' @export
...
#' @describeIn is_failsafe Are any elements of \code{x.} identical to \code{y.}?
#' @export
anyID <- function(x., y.) {any(sapply(x., isID, y.))}

#' @describeIn is_failsafe Are any elements of \code{x.} set-equal to \code{y.}?
#' @export
...
#' @describeIn is_failsafe Are all elements of \code{x.} in the collective set of
#'   atomized values from \code{...}?
#' @export
allIN <- function(x., ...) {all(sapply(x., isIN, ...))}

#' @describeIn is_failsafe Are all elements of \code{x.} identical to \code{y.}?
#' @export
allID <- function(x., y.) {all(sapply(x., isID, y.))}

#' @describeIn is_failsafe Are all elements of \code{x.} set-equal to \code{y.}?
#' @export
...
#' @describeIn is_failsafe Are all elements of \code{x.} scalar \code{TRUE} or
#'   scalar \code{FALSE}?
#' @export
...
#' @describeIn is_failsafe Is exactly one element of \code{x.} in the collective
...
#' @describeIn is_failsafe Is exactly one element of \code{x.} scalar \code{NA}?
#' @export
...
#' @describeIn is_failsafe Is exactly one element of \code{x.} scalar \code{TRUE}
...
#' @describeIn is_failsafe Are two or more elements of \code{x.} scalar, atomic,
#'   and non-\code{NA}?
#' @export
