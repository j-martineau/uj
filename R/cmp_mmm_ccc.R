#' @name cmp_mmm_ccc.
#' @family props
#' @title Complete + extended mode + extended class properties
...
#' @export
cmp_mmm_ccc. <- function() {help("cmp_mmm_uj", package = "uj")}

#' @describeIn cmp_mmm_ccc. Get a character vector of all possible complete +
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete color
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete color
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{iclr}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete even-valued
#'   whole-number array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete even-valued
#'   whole-number dtf?
#'   (\code{\link{icmp}}, \code{\link{ievn}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete factor
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete factor
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{ifac}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete fractional-valued
#'   numeric array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete fractional-valued
#'   numeric dtf?
#'   (\code{\link{icmp}}, \code{\link{ifrc}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete indexer
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete indexer
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{iind}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete logical
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete logical
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{ilgl}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete negative-valued
#'   numeric array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete negative-valued
#'   numeric dtf?
#'   (\code{\link{icmp}}, \code{\link{ineg}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete negative-valued
#'   whole-number dtf?
#'   (\code{\link{icmp}}, \code{\link{ingw}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete non-negative-valued
#'   numeric array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete non-negative-valued
#'   numeric dtf?
#'   (\code{\link{icmp}}, \code{\link{inng}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete non-negative-valued
#'   whole-number dtf?
#'   (\code{\link{icmp}}, \code{\link{innw}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete non-positive-valued
#'   numeric array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete non-positive-valued
#'   numeric dtf?
#'   (\code{\link{icmp}}, \code{\link{inps}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete non-positive-valued
#'   whole-number dtf?
#'   (\code{\link{icmp}}, \code{\link{inpw}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete non-sortable
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete non-sortable
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{inst}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete numeric
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete numeric
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{inum}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete odd-valued
#'   whole-number array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete odd-valued
#'   whole-number dtf?
#'   (\code{\link{icmp}}, \code{\link{iodd}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete ordered-factor
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete ordered-factor
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{iord}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete percent-valued
#'   (0-100) numeric array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete percent-valued
#'   (0-100) numeric dtf?
#'   (\code{\link{icmp}}, \code{\link{ipct}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete positive-valued
#'   numeric array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete positive-valued
#'   numeric dtf?
#'   (\code{\link{icmp}}, \code{\link{ipos}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete proportion-valued
#'   (0-1) numeric array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete proportion-valued
#'   (0-1) numeric dtf?
#'   (\code{\link{icmp}}, \code{\link{ippn}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete positive-valued
#'   whole-number dtf?
#'   (\code{\link{icmp}}, \code{\link{ipsw}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete sortable
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete sortable
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{isrt}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete string
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete string
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{istr}}, \code{\link{idtf}})
#' @export
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete unordered-factor
#'   array?
...
#' @describeIn cmp_mmm_ccc. Is \code{x} a complete unordered-factor
#'   dtf?
#'   (\code{\link{icmp}}, \code{\link{iuno}}, \code{\link{idtf}})
#' @export
