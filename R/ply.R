...
#'   \code{out = xxx}     \tab Inspect the result for properties specified in
#'                             the character vector represented by \code{xxx}
...
#' @export
ply. <- function() {help("ply.", package = "uj")}

#' @describeIn ply. Generalized \code{apply(.)} function.
#' @export
