#' @name cmp_xmd_mat
#' @family props
#' @title complete + xmd + atomic matrix
#' @description See \code{\link{xmd}}, and \code{\link{is_cmp_matrix}}.
#' @param x An object
#' @return \code{TRUE} or \code{FALSE}.
#' @export
cmp_xmd_mat_vals <- function() {
  x <- paste0("cmp_", c("atm", xmd_vals()), "_mat")
  names(x) <- rep.int("cmp_xmd_mat", length(x))
  x
}
