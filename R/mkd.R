...
#' @describeIn mkd Style text as subscript.
#' @export
subs <- function(x) {paste0(v(sub1), x, v(sub2))}

#' @describeIn mkd Style text as superscript.
#' @export
sups <- function(x) {paste0(v(sup1), x, v(sup2))}

#' @describeIn mkd Style text as bold and full blue.
#' @export
bfblu <- function(x) {paste0(v(bblu), x, v(bold2))}

#' @describeIn mkd Style text as bold and light blue.
#' @export
blblu <- function(x) {paste0(v(blblu), x, v(bold2))}

#' @describeIn mkd Style text as bold and medium blue.
#' @export
bmblu <- function(x) {paste0(v(bmblu), x, v(bold2))}

#' @describeIn mkd Style text as bold and dark blue.
#' @export
bdblu <- function(x) {paste0(v(bdblu), x, v(bold2))}

#' @describeIn mkd Style text as bold and full cyan.
#' @export
bfcyn <- function(x) {paste0(v(bcyn), x, v(bold2))}

#' @describeIn mkd Style text as bold and light cyan.
#' @export
blcyn <- function(x) {paste0(v(blcyn), x, v(bold2))}

#' @describeIn mkd Style text as bold and medium cyan.
#' @export
bmcyn <- function(x) {paste0(v(bmcyn), x, v(bold2))}

#' @describeIn mkd Style text as bold and dark cyan.
#' @export
bdcyn <- function(x) {paste0(v(bdcyn), x, v(bold2))}

#' @describeIn mkd Style text as bold and full green.
#' @export
bfgrn <- function(x) {paste0(v(bgrn), x, v(bold2))}

#' @describeIn mkd Style text as bold and light green.
#' @export
blgrn <- function(x) {paste0(v(blgrn), x, v(bold2))}

#' @describeIn mkd Style text as bold and medium green.
#' @export
bmgrn <- function(x) {paste0(v(bmgrn), x, v(bold2))}

#' @describeIn mkd Style text as bold and dark green.
#' @export
bdgrn <- function(x) {paste0(v(bdgrn), x, v(bold2))}

#' @describeIn mkd Style text as bold and full magenta.
#' @export
bfmag <- function(x) {paste0(v(bmag), x, v(bold2))}

#' @describeIn mkd Style text as bold and light magenta.
#' @export
blmag <- function(x) {paste0(v(blmag), x, v(bold2))}

#' @describeIn mkd Style text as bold and medium magenta.
#' @export
bmmag <- function(x) {paste0(v(bmmag), x, v(bold2))}

#' @describeIn mkd Style text as bold and dark magenta.
#' @export
bdmag <- function(x) {paste0(v(bdmag), x, v(bold2))}

#' @describeIn mkd Style text as bold and full orange.
#' @export
bforn <- function(x) {paste0(v(born), x, v(bold2))}

#' @describeIn mkd Style text as bold and light orange.
#' @export
blorn <- function(x) {paste0(v(blorn), x, v(bold2))}

#' @describeIn mkd Style text as bold and medium orange.
#' @export
bmorn <- function(x) {paste0(v(bmorn), x, v(bold2))}

#' @describeIn mkd Style text as bold and dark orange.
#' @export
bdorn <- function(x) {paste0(v(bdorn), x, v(bold2))}

#' @describeIn mkd Style text as bold and 10% grey.
#' @export
bfred <- function(x) {paste0(v(bred), x, v(bold2))}

#' @describeIn mkd Style text as bold and light red.
#' @export
blred <- function(x) {paste0(v(blred), x, v(bold2))}

#' @describeIn mkd Style text as bold and medium red.
#' @export
bmred <- function(x) {paste0(v(bmred), x, v(bold2))}

#' @describeIn mkd Style text as bold and dark red.
#' @export
bdred <- function(x) {paste0(v(bdred), x, v(bold2))}

#' @describeIn mkd Style text as bold and full violet.
#' @export
bfvlt <- function(x) {paste0(v(bvlt), x, v(bold2))}

#' @describeIn mkd Style text as bold and light violet.
#' @export
blvlt <- function(x) {paste0(v(blvlt), x, v(bold2))}

#' @describeIn mkd Style text as bold and medium violet.
#' @export
bmvlt <- function(x) {paste0(v(bmvlt), x, v(bold2))}

#' @describeIn mkd Style text as bold and dark violet.
#' @export
...
#' @describeIn mkd Style text as bold and light yellow.
#' @export
blylw <- function(x) {paste0(v(blylw), x, v(bold2))}

#' @describeIn mkd Style text as bold and medium yellow.
#' @export
bmylw <- function(x) {paste0(v(bmylw), x, v(bold2))}

#' @describeIn mkd Style text as bold and dark yellow.
#' @export
...
#' @describeIn mkd Style text as bold and 95% grey.
#' @export
bg95 <- function(x) {paste0(v(bg95), x, v(bold2))}

#' @describeIn mkd Style text as bold and 90% grey.
#' @export
bg90 <- function(x) {paste0(v(bg90), x, v(bold2))}

#' @describeIn mkd Style text as bold and 85% grey.
#' @export
bg85 <- function(x) {paste0(v(bg85), x, v(bold2))}

#' @describeIn mkd Style text as bold and 80% grey.
#' @export
bg80 <- function(x) {paste0(v(bg80), x, v(bold2))}

#' @describeIn mkd Style text as bold and 70% grey.
#' @export
...
#' @describeIn mkd Style text as bold and 65% grey.
#' @export
bg65 <- function(x) {paste0(v(bg65), x, v(bold2))}

#' @describeIn mkd Style text as bold and 60% grey.
#' @export
bg60 <- function(x) {paste0(v(bg60), x, v(bold2))}

#' @describeIn mkd Style text as bold and 55% grey.
#' @export
bg55 <- function(x) {paste0(v(bg55), x, v(bold2))}

#' @describeIn mkd Style text as bold and 50% grey.
#' @export
bg50 <- function(x) {paste0(v(bg50), x, v(bold2))}

#' @describeIn mkd Style text as bold and 45% grey.
#' @export
bg45 <- function(x) {paste0(v(bg45), x, v(bold2))}

#' @describeIn mkd Style text as bold and 40% grey.
#' @export
bg40 <- function(x) {paste0(v(bg40), x, v(bold2))}

#' @describeIn mkd Style text as bold and 35% grey.
#' @export
bg35 <- function(x) {paste0(v(bg35), x, v(bold2))}

#' @describeIn mkd Style text as bold and 30% grey.
#' @export
bg30 <- function(x) {paste0(v(bg30), x, v(bold2))}

#' @describeIn mkd Style text as bold and 25% grey.
#' @export
bg25 <- function(x) {paste0(v(bg25), x, v(bold2))}

#' @describeIn mkd Style text as bold and 20% grey.
#' @export
bg20 <- function(x) {paste0(v(bg20), x, v(bold2))}

#' @describeIn mkd Style text as bold and 15% grey.
#' @export
...
#' @describeIn mkd Style text as bold and black.
#' @export
bblk <- function(x) {paste0(v(bblk), x, v(bold2))}

#' @describeIn mkd Style text as bold and invisible (1/256th opaque).
#' @export
binv <- function(x) {paste0(v(binv), x, v(bold2))}

#' @describeIn mkd Style text as plain and full blue.
#' @export
pfblu <- function(x) {paste0(v(pblu), x, v(plain2))}

#' @describeIn mkd Style text as plain and light blue.
#' @export
plblu <- function(x) {paste0(v(plblu), x, v(plain2))}

#' @describeIn mkd Style text as plain and medium blue.
#' @export
pmblu <- function(x) {paste0(v(pmblu), x, v(plain2))}

#' @describeIn mkd Style text as plain and dark blue.
#' @export
pdblu <- function(x) {paste0(v(pdblu), x, v(plain2))}

#' @describeIn mkd Style text as plain and full cyan.
#' @export
pfcyn <- function(x) {paste0(v(pcyn), x, v(plain2))}

#' @describeIn mkd Style text as plain and light cyan.
#' @export
plcyn <- function(x) {paste0(v(plcyn), x, v(plain2))}

#' @describeIn mkd Style text as plain and medium cyan.
#' @export
pmcyn <- function(x) {paste0(v(pmcyn), x, v(plain2))}

#' @describeIn mkd Style text as plain and dark cyan.
#' @export
...
#' @describeIn mkd Style text as plain and medium green.
#' @export
pmgrn <- function(x) {paste0(v(pmgrn), x, v(plain2))}

#' @describeIn mkd Style text as plain and dark green.
#' @export
pdgrn <- function(x) {paste0(v(pdgrn), x, v(plain2))}

#' @describeIn mkd Style text as plain and full magenta.
#' @export
pfmag <- function(x) {paste0(v(pmag), x, v(plain2))}

#' @describeIn mkd Style text as plain and light magenta.
#' @export
plmag <- function(x) {paste0(v(plmag), x, v(plain2))}

#' @describeIn mkd Style text as plain and medium magenta.
#' @export
pmmag <- function(x) {paste0(v(pmmag), x, v(plain2))}

#' @describeIn mkd Style text as plain and dark magenta.
#' @export
pdmag <- function(x) {paste0(v(pdmag), x, v(plain2))}

#' @describeIn mkd Style text as plain and full orange.
#' @export
pforn <- function(x) {paste0(v(porn), x, v(plain2))}

#' @describeIn mkd Style text as plain and light orange.
#' @export
plorn <- function(x) {paste0(v(plorn), x, v(plain2))}

#' @describeIn mkd Style text as plain and medium orange.
#' @export
pmorn <- function(x) {paste0(v(pmorn), x, v(plain2))}

#' @describeIn mkd Style text as plain and dark orange.
#' @export
...
#' @describeIn mkd Style text as plain and light red.
#' @export
plred <- function(x) {paste0(v(plred), x, v(plain2))}

#' @describeIn mkd Style text as plain and medium red.
#' @export
pmred <- function(x) {paste0(v(pmred), x, v(plain2))}

#' @describeIn mkd Style text as plain and dark red.
#' @export
pdred <- function(x) {paste0(v(pdred), x, v(plain2))}

#' @describeIn mkd Style text as plain and full violet.
#' @export
pfvlt <- function(x) {paste0(v(pvlt), x, v(plain2))}

#' @describeIn mkd Style text as plain and light violet.
#' @export
plvlt <- function(x) {paste0(v(plvlt), x, v(plain2))}

#' @describeIn mkd Style text as plain and medium violet.
#' @export
pmvlt <- function(x) {paste0(v(pmvlt), x, v(plain2))}

#' @describeIn mkd Style text as plain and dark violet.
#' @export
...
#' @describeIn mkd Style text as plain and light yellow.
#' @export
plylw <- function(x) {paste0(v(plylw), x, v(plain2))}

#' @describeIn mkd Style text as plain and medium yellow.
#' @export
pmylw <- function(x) {paste0(v(pmylw), x, v(plain2))}

#' @describeIn mkd Style text as plain and dark yellow.
#' @export
...
#' @describeIn mkd Style text as plain and 95% grey.
#' @export
pg95 <- function(x) {paste0(v(pg95), x, v(plain2))}

#' @describeIn mkd Style text as plain and 90% grey.
#' @export
pg90 <- function(x) {paste0(v(pg90), x, v(plain2))}

#' @describeIn mkd Style text as plain and 85% grey.
#' @export
pg85 <- function(x) {paste0(v(pg85), x, v(plain2))}

#' @describeIn mkd Style text as plain and 80% grey.
#' @export
pg80 <- function(x) {paste0(v(pg80), x, v(plain2))}

#' @describeIn mkd Style text as plain and 70% grey.
#' @export
...
#' @describeIn mkd Style text as plain and 65% grey.
#' @export
pg65 <- function(x) {paste0(v(pg65), x, v(plain2))}

#' @describeIn mkd Style text as plain and 60% grey.
#' @export
pg60 <- function(x) {paste0(v(pg60), x, v(plain2))}

#' @describeIn mkd Style text as plain and 55% grey.
#' @export
pg55 <- function(x) {paste0(v(pg55), x, v(plain2))}

#' @describeIn mkd Style text as plain and 50% grey.
#' @export
pg50 <- function(x) {paste0(v(pg50), x, v(plain2))}

#' @describeIn mkd Style text as plain and 45% grey.
#' @export
pg45 <- function(x) {paste0(v(pg45), x, v(plain2))}

#' @describeIn mkd Style text as plain and 40% grey.
#' @export
pg40 <- function(x) {paste0(v(pg40), x, v(plain2))}

#' @describeIn mkd Style text as plain and 35% grey.
#' @export
pg35 <- function(x) {paste0(v(pg35), x, v(plain2))}

#' @describeIn mkd Style text as plain and 30% grey.
#' @export
pg30 <- function(x) {paste0(v(pg30), x, v(plain2))}

#' @describeIn mkd Style text as plain and 25% grey.
#' @export
pg25 <- function(x) {paste0(v(pg25), x, v(plain2))}

#' @describeIn mkd Style text as plain and 20% grey.
#' @export
